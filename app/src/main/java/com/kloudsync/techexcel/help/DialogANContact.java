...
public class DialogANContact {
    ...
    public void GotoChangeCode() {
        Intent intent = new Intent(mContext, com.kloudsync.techexcel5.start.ChangeCountryCode.class);
        String code = tv_cphone.getText().toString();
        code = code.replaceAll("\\+", "");
        AppConfig.COUNTRY_CODE = Integer.parseInt(code);
        ((Activity) mContext).startActivityForResult(intent, com.kloudsync.techexcel5.start.RegisterActivity.CHANGE_COUNTRY_CODE);
