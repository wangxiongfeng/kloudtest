...
import com.kloudsync.techexcel5.bean.DeviceType;
...
import com.kloudsync.techexcel5.dialog.PopMeetingAuditorMemberSetting;
import com.kloudsync.techexcel5.dialog.PopMeetingHandsMemberSetting;
import com.kloudsync.techexcel5.dialog.PopMeetingMemberSetting;
import com.kloudsync.techexcel5.dialog.PopMeetingSpeakMemberSetting;
...
import com.kloudsync.techexcel5.view.CircleImageView;
...
import static com.kloudsync.techexcel5.bean.MeetingMember.TYPE_ITEM_HANDSUP_MEMBER;
import static com.kloudsync.techexcel5.bean.MeetingMember.TYPE_ITEM_MAIN_SPEAKER;
import static com.kloudsync.techexcel5.bean.MeetingMember.TYPE_ITEM_SPEAKING_SPEAKER;
...
//                    if(!TextUtils.isEmpty(host))mainSpeakerViewHolder.presenter.setText(host);
                ...
                if (meetingConfig.isMeetingPause()) {
                    if (meetingConfig.isCoaching()) {
                        ...
                        if(member.getUserId()==agoraMember.getUserId()){
