package com.kloudsync.techexcel5.ui;
...
import com.kloudsync.techexcel5.bean.AccountSettingBean;
import com.kloudsync.techexcel5.bean.BookNote;
import com.kloudsync.techexcel5.bean.DocumentPage;
import com.kloudsync.techexcel5.bean.EventChangeCameraSize;
import com.kloudsync.techexcel5.bean.EventClose;
import com.kloudsync.techexcel5.bean.EventCloseNoteView;
import com.kloudsync.techexcel5.bean.EventCloseShare;
import com.kloudsync.techexcel5.bean.EventCreateSync;
import com.kloudsync.techexcel5.bean.EventDeleteDocs;
import com.kloudsync.techexcel5.bean.EventExit;
import com.kloudsync.techexcel5.bean.EventExpanedUserList;
import com.kloudsync.techexcel5.bean.EventFloatingNote;
import com.kloudsync.techexcel5.bean.EventHideMeetingMenu;
import com.kloudsync.techexcel5.bean.EventHighlightNote;
import com.kloudsync.techexcel5.bean.EventInviteUsers;
import com.kloudsync.techexcel5.bean.EventKickOffMember;
import com.kloudsync.techexcel5.bean.EventMeetingDocuments;
import com.kloudsync.techexcel5.bean.EventMute;
import com.kloudsync.techexcel5.bean.EventNote;
import com.kloudsync.techexcel5.bean.EventNoteErrorShowDocument;
import com.kloudsync.techexcel5.bean.EventNotePageActions;
import com.kloudsync.techexcel5.bean.EventOpenNote;
import com.kloudsync.techexcel5.bean.EventOpenOrCloseBluethoothNote;
import com.kloudsync.techexcel5.bean.EventPageActions;
import com.kloudsync.techexcel5.bean.EventPageNotes;
import com.kloudsync.techexcel5.bean.EventPlaySoundtrack;
import com.kloudsync.techexcel5.bean.EventPresnterChanged;
import com.kloudsync.techexcel5.bean.EventRefreshDocs;
import com.kloudsync.techexcel5.bean.EventRefreshMembers;
import com.kloudsync.techexcel5.bean.EventSelectNote;
...
import com.kloudsync.techexcel5.bean.EventSendJoinMeetingMessage;
import com.kloudsync.techexcel5.bean.EventSetPresenter;
import com.kloudsync.techexcel5.bean.EventShareDocInMeeting;
import com.kloudsync.techexcel5.bean.EventShareScreen;
import com.kloudsync.techexcel5.bean.EventShowFullAgora;
import com.kloudsync.techexcel5.bean.EventShowMenuIcon;
import com.kloudsync.techexcel5.bean.EventShowNotePage;
import com.kloudsync.techexcel5.bean.EventSocketMessage;
import com.kloudsync.techexcel5.bean.HelloMessage;
import com.kloudsync.techexcel5.bean.JoinMeetingMessage;
import com.kloudsync.techexcel5.bean.MeetingChangeBean;
import com.kloudsync.techexcel5.bean.MeetingConfig;
import com.kloudsync.techexcel5.bean.MeetingDocument;
import com.kloudsync.techexcel5.bean.MeetingMember;
import com.kloudsync.techexcel5.bean.MeetingPauseOrResumBean;
import com.kloudsync.techexcel5.bean.MeetingType;
import com.kloudsync.techexcel5.bean.NoteDetail;
import com.kloudsync.techexcel5.bean.NoteId;
import com.kloudsync.techexcel5.bean.SoundTrack;
import com.kloudsync.techexcel5.bean.SoundtrackDetail;
import com.kloudsync.techexcel5.bean.SoundtrackDetailData;
import com.kloudsync.techexcel5.bean.SoundtrackMediaInfo;
import com.kloudsync.techexcel5.bean.SupportDevice;
import com.kloudsync.techexcel5.bean.TvDevice;
import com.kloudsync.techexcel5.bean.VedioData;
import com.kloudsync.techexcel5.bean.params.EventSoundSync;
import com.kloudsync.techexcel5.config.AppConfig;
import com.kloudsync.techexcel5.config.RealMeetingSetting;
import com.kloudsync.techexcel5.dialog.AddFileFromDocumentDialog;
import com.kloudsync.techexcel5.dialog.AddFileFromFavoriteDialog;
import com.kloudsync.techexcel5.dialog.AddWxDocDialog;
import com.kloudsync.techexcel5.dialog.AddWxDocDialog.OnDocSavedListener;
import com.kloudsync.techexcel5.dialog.BeInvitedCoachAudienceDialog;
import com.kloudsync.techexcel5.dialog.CenterToast;
import com.kloudsync.techexcel5.dialog.KickOffMemberDialog;
import com.kloudsync.techexcel5.dialog.MeetingMembersDialog;
import com.kloudsync.techexcel5.dialog.MeetingRecordManager;
import com.kloudsync.techexcel5.dialog.MemberDisplayModeSettingDialog;
import com.kloudsync.techexcel5.dialog.PopSpeakerWindowMore;
import com.kloudsync.techexcel5.dialog.RecordNoteActionManager;
import com.kloudsync.techexcel5.dialog.ShareDocInMeetingDialog;
import com.kloudsync.techexcel5.dialog.SoundtrackPlayDialog;
import com.kloudsync.techexcel5.dialog.SoundtrackPlayManager;
import com.kloudsync.techexcel5.dialog.SoundtrackRecordManager;
import com.kloudsync.techexcel5.dialog.UploadFileDialog;
import com.kloudsync.techexcel5.dialog.plugin.UserNotesDialog;
import com.kloudsync.techexcel5.filepicker.FileEntity;
import com.kloudsync.techexcel5.filepicker.FilePickerActivity;
import com.kloudsync.techexcel5.filepicker.PickerManager;
import com.kloudsync.techexcel5.help.AddDocumentTool;
import com.kloudsync.techexcel5.help.ApiTask;
import com.kloudsync.techexcel5.help.AudiencePromptDialog;
import com.kloudsync.techexcel5.help.BottomMenuManager;
import com.kloudsync.techexcel5.help.ChatManager;
import com.kloudsync.techexcel5.help.DeviceManager;
import com.kloudsync.techexcel5.help.DocVedioManager;
import com.kloudsync.techexcel5.help.FollowSpearkerModeManager;
import com.kloudsync.techexcel5.help.MeetingKit;
import com.kloudsync.techexcel5.help.MeetingPauseManager;
import com.kloudsync.techexcel5.help.NoteViewManager;
import com.kloudsync.techexcel5.help.PageActionsAndNotesMgr;
import com.kloudsync.techexcel5.help.PopBottomChat;
import com.kloudsync.techexcel5.help.PopBottomFile;
import com.kloudsync.techexcel5.help.PopBottomMenu;
import com.kloudsync.techexcel5.help.SetPresenterDialog;
import com.kloudsync.techexcel5.help.ShareDocumentDialog;
import com.kloudsync.techexcel5.help.ThreadManager;
import com.kloudsync.techexcel5.help.UserData;
import com.kloudsync.techexcel5.info.Uploadao;
import com.kloudsync.techexcel5.response.DevicesResponse;
import com.kloudsync.techexcel5.service.ConnectService;
import com.kloudsync.techexcel5.tool.CameraRecyclerViewTouchListener;
import com.kloudsync.techexcel5.tool.DocumentModel;
import com.kloudsync.techexcel5.tool.DocumentPageCache;
import com.kloudsync.techexcel5.tool.DocumentUploadTool;
import com.kloudsync.techexcel5.tool.LocalNoteManager;
import com.kloudsync.techexcel5.tool.MeetingSettingCache;
import com.kloudsync.techexcel5.tool.QueryLocalNoteTool;
import com.kloudsync.techexcel5.tool.SocketMessageManager;
import com.kloudsync.techexcel5.tool.ToastUtils;
...
import static com.kloudsync.techexcel5.bean.MeetingMember.TYPE_ITEM_MAIN_SPEAKER;
...
//        String url = AppConfig.URL_MEETING_BASE + "company/account_info?companyId=" + AppConfig.SchoolID;
        ...
        meetingConfig.setSystemType(AppConfig.systemType);
...
//        }
    ...
    public void onInviteAudienceClicked(AgoraMember agoraMember) {
        processInviteProvateCoachAudience(agoraMember);
    }
...
//                handleMemberSpeakingMessage(socketMessage.getData());
            ...
            case SocketMessageManager.MEETING_JOIN_PRIVATE_COACHING_AS_STUDENT:
                if (meetingConfig.getSystemType() != 0 && meetingConfig.isMeetingPause()) {
                    ...
                    if (coachingAsStudetData.has("retData")) {
                        try {
                            ...
                            if (retData.has("inviteUserId")) {
                                int index = meetingConfig.getAgoraMembers().indexOf(new AgoraMember(retData.getInt("inviteUserId")));
                                if (index >= 0) {
                                    followStartPrivateCoaching(meetingConfig.getAgoraMembers().get(index));
                                }
                            }

                            if (retData.has("hostUserId")) {
                                int index = meetingConfig.getAgoraMembers().indexOf(new AgoraMember(retData.getInt("hostUserId")));
                                if (index >= 0) {
                                    MeetingKit.getInstance().muteAllExceptCoachMember(meetingConfig.getAgoraMembers().get(index));
                                }
                ...
                break;
            case SocketMessageManager.MEETING_INVITE_TO_PRIVATE_COACHING_AS_AUDIENCE:
                if (meetingConfig.isCoaching()) {
                    ...
                    if (socketMessage.getData().has("retData")) {
                        try {
                            String id = socketMessage.getData().getString("retData");
                            if (cameraAdapter != null) {
                                int index = meetingConfig.getAgoraMembers().indexOf(new AgoraMember(Integer.parseInt(AppConfig.UserID)));
                                if (index >= 0) {
    ...
    private void showInVitedCoachAudienceDialog() {
        ...
        beInvitedCoachAudienceDialog.show();
    }
...
//                    }
    ...
    private void adjustPrivateCoachingInfoInHelloMessage(JSONArray privateCoachingMembers) {
        Log.e("adjustPrivateCoachingInfoInHelloMessage", "in");
        ...
        if (privateCoachingMembers != null && privateCoachingMembers.length() > 0) {
            ...
            for (int i = 0; i < privateCoachingMembers.length(); ++i) {
                try {
                    ...
                    MeetingKit.getInstance().unmuteCoachMember(Integer.parseInt(_member.getString("userId")));
            ...
            Log.e("adjustPrivateCoachingInfoInHelloMessage", "hasAudience:" + hasAudience);
            if (!hasAudience) {
...
//            }
    ...
    private synchronized void followChangeDocument(int itemId, int pageNumber) {
        Log.e("followChangeDocument", "documents:" + documents);
        if (documents == null || documents.size() == 0) {
            DocumentModel.asyncGetDocumentsInDocAndRefreshFileList(meetingConfig, itemId, pageNumber);
            return;
        }
        ...
        MeetingDocument _document = documents.get(index);
        if (meetingConfig.getDocument() != null && meetingConfig.getDocument().equals(_document)) {
            return;
        }
        changeDocument(_document, pageNumber);
...
//            }
            ...
            if (meetingConfig.getSystemType() == 0) {
                ...
                if (meetingConfig.isMeetingPause()) {
                    Log.e("check_selecr_coach", "doSelectPrivateCoach");
                    if (meetingConfig.isCoaching()) {
                        // 当前private coach的人
...
//                sharedPreferences.edit().putInt("display_mode", 0).commit();
            ...
            public void accept(JSONObject jsonObject) throws Exception {
                if (jsonObject != null && jsonObject.has("code")) {
                    ...
                    if (code == 0) {
                        // 开启成功;
                        //开启一对一成功
                        handleStartPrivateCoachingSucc(member);
                        justHandleDisplayMode(0);
                        if (cameraAdapter != null) {
                            cameraAdapter.setSpeakerMember(getSelectedAgora(member.getUserId() + ""));
    ...
    private void processInviteProvateCoachAudience(final AgoraMember member) {
        Observable.just(member).observeOn(Schedulers.io()).map(new Function<AgoraMember, JSONObject>() {
            @Override
            public JSONObject apply(final AgoraMember member) throws Exception {
                JSONObject params = new JSONObject();
...
//                {"userIdList":[225017017]}
    ...
    private void handleStartPrivateCoachingSucc(AgoraMember member) {
        meetingConfig.setCoaching(true);
        MeetingKit.getInstance().muteAllExceptCoachMember(member);
    ...
    private void handlePrivateCoachingOver() {

    }

    private void followStartPrivateCoaching(AgoraMember member) {
        meetingConfig.setCoaching(true);
        MeetingKit.getInstance().muteAllExceptCoachMember(member);
        meetingConfig.setPrivateCoachMember(member.getUserId());
        if (mMeetingPauseManager != null) {
        ...
        if ((member.getUserId() + "").equals(AppConfig.UserID)) {
            ...
            if (messageManager != null) {
                messageManager.sendMessage_DocumentShowedLocalChanged(meetingConfig);
            }
            // 发送切换文档的消息给老师
        }
...
//                    Log.e("MeetingConfig","MeetingConfig:" + meetingConfig);
    ...
    private void handleJoinPrivateCoachingMeeting(JSONArray privateCoachingMembers) {
        ...
        Log.e("handleJoinPrivateCoachingMeeting", "privateCoachingMembers:" + privateCoachingMembers);
        meetingConfig.setCoaching(true);
        MeetingKit.getInstance().muteAllMember();
        if (privateCoachingMembers != null && privateCoachingMembers.length() > 0) {
            for (int i = 0; i < privateCoachingMembers.length(); ++i) {
                try {
                    JSONObject _member = privateCoachingMembers.getJSONObject(i);
