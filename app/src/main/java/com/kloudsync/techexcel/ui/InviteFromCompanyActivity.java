...
import com.kloudsync.techexcel5.adapter.InviteFromCompanyAdapter;
...
import com.kloudsync.techexcel5.help.InviteNewContactDialog;
            ...
            public void onResponse(Call<NetworkResponse> call, Response<NetworkResponse> response) {
                if (response != null && response.isSuccessful()) {
                    if (response.body().getRetCode() == 0) {
                        Toast.makeText(getApplicationContext(), "add team admin success", Toast.LENGTH_SHORT).show();//error_code_mine
                        setResult(RESULT_OK);
                        finish();
                    } else {
                        Toast.makeText(getApplicationContext(), "add failed", Toast.LENGTH_SHORT).show();//error_code_mine
                    }
                }
            }
